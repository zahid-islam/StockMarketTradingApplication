<%@ Page Title="" Language="C#" MasterPageFile="~/iTradex.Master" AutoEventWireup="true" CodeBehind="IPOAplication.aspx.cs" Inherits="iTradex.UI.Pages.Investor.IPOAplication" %>
                    ...
                    <div class="sidebar_widget">
                        <div class="vertical_navigation">
                           <ul>
                                ...
                                <li><a class="active" href="IPOAplication.aspx"><i class="icon-book_alt2">
                                </i>IPO Application</a></li>
                                <li><a href="FundWithdrawRequestBroker.aspx"><i class="icon-book_alt2">
                                ...
                                <div class="idate_picker" id="baseDateControl" class="dateRange">
                                     ...
                                     <li>
                                            ...
                                            <asp:DropDownList ID="ddlCompany" runat="server" 
                                               Width=254px  AppendDataBoundItems=true>
                                        ...
                                        <li>
                                             <button id="btnIPOApplication" runat=server onserverclick="btnIPOApplication_Click" class="btn appBtn btn-primary FundWithdrawBrokerButton"> <i class="icon-checkmark"></i> Apply</button>
                                        </li>
                                        <li></li>
                                    </ul>
                                </div>
                    ...
                    <div class="row-fluid m_b30 remove5" id="nine" data-step="5" data-intro="This Box Contains Ladger Informations">
                        <div class="span12  widget">
                            <header class="whead w_header light">
                                <h2>
                                    <i class="icon-book-2"></i>List Of IPO Applicatios</h2>
                                <ul class="control">
                                    ...
                                    <div class="span12 padding10">
                                        <div class="shownpars">
                                            <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                                               <asp:Repeater ID="rptIPOApplication" runat="server">
                                                    <HeaderTemplate>
                                        ...
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Latest EPS</th>	
                                                                    ...
                                                                    <th class="dttableleftalign">
                                                                        AccountNumber <span style="display: block;" class="sorting"></span>
                                                                    </th>
                                                                    <th class="dttableleftalign">
                                                                        BONumber
                                                                    </th>
                                                    ...
                                                    <ItemTemplate>
                                                     <tr class="gradeA odd">
                                                            ...
                                                            <%--<td class="dttableleftalign"><%# Eval("LastLoginTime")%></td>--%>
                                                            <td class="dttablerightalign">
                                                                <asp:Label ID="lblCurrentBalance" runat="server" Text='<%# Eval("AccountBalance")%>'></asp:Label>
                                                            </td>
                                                             <td class="dttableleftalign">
                                                            ...
                                                            <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "CompanyName") %>' />
                                                            <asp:HiddenField ID="HiddenField2" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IPOReference") %>' />
                                                        </tr>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        </tbody> </table>
