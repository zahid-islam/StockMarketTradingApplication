<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="iTradex.UI.Pages.Investor.LoginPage" %>
             ...
             <li><i class="icon-lock_fill iconLogin"></i><b>  Security Guidelines:</b></li>
                ...
                <ul class="Guidelines">
                    ...
                    <li>Change your password regularly. We recommend changing your password every 60 to
                        90 days.</li>
                    <li>For any query please call +880 2 9820561 Ext- 234 or mail to itradex@mikasecurities.net</li>
