<%@ Page Title="" Language="C#" MasterPageFile="~/iTradex.Master" AutoEventWireup="true" CodeBehind="PurchaseOrder.aspx.cs" Inherits="iTradex.UI.Pages.Investor.PurchaseOrder" %>
         ...
         <div id="myModal2" class="modal hide fade CrudModal2 " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="PurchaseModalBody">
               <div id="AddEditForm">
                ...
                <legend class="form-ligendPurchase">
                <span>Purchase Order</span>
                  ...
                  <div class="firstDiv "  >                  
                     ...
                     <%-- <span class="EditForm">Rate</span>--%>
                      <asp:TextBox ID="txtRate" runat="server" class="FundWithdrawlTextBox onlyNumeric2" TabIndex=4 placeholder="Rate"></asp:TextBox>
                      </li>
                          </ContentTemplate>
                              </asp:UpdatePanel>
                       <li>
			     ...
			     <div class="sidebar_widget">
                      <div class="vertical_navigation">
                             <ul>
                                ...
                                <li><a class="active" href="PurchaseOrder.aspx" title=""> <i class="icon-briefcase-2"> </i>Purchase Orders</a></li>
             ...
             --%>
    		   <div class="row-fluid m_b30 remove5" id="nine" data-step="5" data-intro="This Box Contains Ladger Informations">
                   <div class="span12  widget" >
                     <header class="whead w_header light"><h2><i class="icon-book-2"></i> Purchase Orders</h2>
                        <ul class="control">
                        	<li class="dropdown">
                           ...
                           <div class="span12 padding10">
							<div class="shownpars">
								<div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                                    ...
                                    <asp:Repeater ID="rptPurchaseOrder" runat="server">
								...
								<thead>
                                 ...
                                 <ItemTemplate>
									<tr class="gradeA odd">
                                     <td><%#DateTime.Parse(Eval("TransactionTime").ToString()).ToString("dd-MMM-yyyy")%></td>
                                     <td><%#DateTime.Parse(Eval("TransactionTime").ToString()).ToString("T")%></td>
										<td class="dttableleftalign"><%# Eval("Instrument")%></td>
                                        <td class="dttableleftalign"><%# Eval("TransactionType")%></td>
										<%--<td class="dttablerightalign"><%# Eval("Memo")%></td>--%>
