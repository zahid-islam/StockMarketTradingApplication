<%@ Page Title="" Language="C#" MasterPageFile="~/iTradex.Master" AutoEventWireup="true" CodeBehind="Ledger.aspx.cs" Inherits="iTradex.UI.Pages.Investor.Ledger" %>
               ...
               <div id="AddEditForm">
                ...
                <span>New Password</span>
                  ...
                  <div class="firstDiv "  >                  
                   ...
                   <button id="Button3" runat=server  class="btn appBtn btn-primary btnFormPurchase btnChangePassword" onserverclick="btnSave_Click" tabindex=5><i class="icon-plus-2"></i> Save</button>
			 ...
			 <div class="span3 sidebar_widget_container">
			     <div class="sidebar_widget">
                      <div class="vertical_navigation">
                             <ul>
                            	<li><a class="active" href="Ledger.aspx" title=""><i class="icon-book_alt2"> </i>Instrument Ledger</a></li>
                                <li><a href="Instrument.aspx" title=""> <i class="icon-briefcase-2"> </i>Instrument</a></li>
                                <%--<li><a href="#" title=""> <i class="icon-remove"> </i> Fund Withdraw Deposit </a></li>--%>
                            </ul>                                              
                      </div>
			 ...
			 <div class="span9 widget_container" id="sortable">
                         ...
                         <div id="rga" class="full_widget light_gray_border collapse in" data-step="4" data-intro="This Box Contains Date Picking Options">
                          	<div class="idate_picker" id="baseDateControl" class="dateRange">
                                 ...
                                 <ul class="ledgerFilter">
                                  ...
                                  <li>
                                       <button id="Button1" runat=server onserverclick="btnSubmitDate_Click" class="btn appBtn btn-primary ledgerButton"> <i class="icon-checkmark"></i> Apply</button> 
                                            <%-- <asp:Button ID="btnSubmitDate" class="btn appBtn btn-primary" runat="server" 
                                            Text="Apply" onclick="btnSubmitDate_Click" OnClientClick="javascript:Copy();return false;"/>--%>
                             <button id="Button2" runat=server onserverclick="btnPrint_Click" class="btn appBtn btn-primary  btnTransactionPrint fwBtn2  ledgerPrintButton " ><i class=" icon-file-pdf"></i> Print</button>
    		   ...
    		   <div class="row-fluid m_b30 remove5" id="nine" data-step="5" data-intro="This Box Contains Ladger Informations">
                   <div class="span12 widget">
                     <header class="whead w_header light"><h2><i class="icon-book-2"></i>Instrument Ledger</h2>
                        <ul class="control">
                        	<li class="dropdown">
                       ...
                       <div class="row-fluid">
                           <div class="span12 padding10">
							<div class="shownpars">
							 ...
							 <asp:Repeater ID="rptInstrumentLedger" runat="server">
                                    
                                  <HeaderTemplate>
                                
								<table cellspacing="0" cellpadding="0" border="0" class="dTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                                
								<thead>
                                
                                   <tr role="row"> <th class="balanceForward" colspan="10" style="text-align: right ;"><strong>Balance Forward <asp:Label ID="lblBalanceForward" runat="server"></asp:Label></strong></th></tr>
									<tr role="row">
                                 
									<%--	<th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">TranDate<span style="display: block;" class="sorting"></span></th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Buy</th>
										 <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">BuyRate</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Sale</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">SaleRate</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Received</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Issue</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Balance</th>--%>
										<%--<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">SaleRate</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Received</th>
										<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Issued</th>	
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">RealizedGainLoss</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">TranType</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Commission</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">LockinBalance</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">MaturedDate</th>	--%>

                                        <th class="dttableleftalign">TranDate<span style="display: block;" class="sorting"></span></th>
										<th class="dttablerightalign">Buy</th>
										<th class="dttablerightalign">BuyRate</th>
										<th class="dttablerightalign">Sale</th>
										<th class="dttablerightalign">SaleRate</th>
										<th class="dttablerightalign">Received</th>
										<th class="dttablerightalign">Issue</th>
                                        <th class="dttablerightalign">Balance</th>
                                        </tr>
								</thead>
                                 ...
                                 <ItemTemplate>
									<tr class="gradeA odd">
										...
										<td class="dttableleftalign"><%#DateTime.Parse(Eval("TranDate").ToString()).ToString("dd-MMM-yyyy")%></td>
										<td class="dttablerightalign"><%# Eval("Buy", "{0:00.}")%></td>
										<%--<td><%# Eval("NetBuyAmount",  "{0:00.00}")%></td>--%>
										<td class="dttablerightalign"><%# Eval("BuyRate", "{0:###,###,0.00}")%></td>
										<td class="dttablerightalign"><%# Eval("Sale", "{0:00.}")%></td>
										<%--<td><%# Eval("NetSaleAmount", "{0:00.00}")%></td>--%>
										<td class="dttablerightalign"><%# Eval("SaleRate", "{0:###,###,0.00}")%></td>
										<td class="dttablerightalign"><%# Eval("Receive", "{0:00.}")%></td>
										<td class="dttablerightalign"><%# Eval("Issue", "{0:00.}")%></td>
                                        <td class="dttablerightalign"><%# Eval("Balance", "{0:00.}")%></td>
                                   <%--     <td><%# Eval("RealizedGainLoss" ,"{0:00.00}")%></td>
                                        <td><%# Eval("TranType")%></td>
                                        <td><%# Eval("Commission" ,"{0:00.00}")%></td>
                                        <td><%# Eval("LockinBalance", "{0:00.00}")%></td>
                                        <td><%# DataBinder.Eval(Container.DataItem, "MaturedDate", "{0: dd/MM/yyyy}")%></td>--%>
									</tr>
...
//                });
       ...
       <%-- <script type="text/javascript">
            function Copy() {
                ...
                $("#<%=rangeBb.ClientID%>").text(date); //set value
                 return false;
            }
