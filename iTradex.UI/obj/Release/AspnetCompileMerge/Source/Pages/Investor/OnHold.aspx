<%@ Page Title="" Language="C#" MasterPageFile="~/iTradex.Master" AutoEventWireup="true" CodeBehind="OnHold.aspx.cs" Inherits="iTradex.UI.Pages.Investor.OnHold" %>
			     ...
			     <div class="sidebar_widget">
                      <div class="vertical_navigation">
                             <ul>
                                ...
                                <li><a class="active" href="OnHold.aspx" title=""> <i class="icon-remove"> </i>Users On Hold</a></li>
             ...
             --%>
    		   <div class="row-fluid m_b30 remove5" id="nine" data-step="5" data-intro="This Box Contains Ladger Informations">
                   <div class="span12  widget" >
                     <header class="whead w_header light"><h2><i class="icon-book-2"></i> List Of Users On Hold</h2>
                        <ul class="control">
                        	<li class="dropdown">
                           ...
                           <div class="span12 padding10">
							<div class="shownpars">
								...
								<%--		<th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Date<span style="display: block;" class="sorting"></span></th>
                                        ...
                                        <th>UserID<span style="display: block;" class="sorting"></span></th>
										<th>AccountNumber</th>
										<th>BONumber</th>
                                 ...
                                 <ItemTemplate>
									<tr class="gradeA odd">
										...
										<td class="dttablerightalign"><%# Eval("AccountNumber")%></td>
										<td class="dttablerightalign"><%# Eval("BONumber")%></td>
