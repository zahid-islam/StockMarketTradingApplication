<%@ Page Title="" Language="C#" MasterPageFile="~/iTradex.Master" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="iTradex.UI.Pages.Investor.Order" %>
            ...
            <div class="span8">
                <ul class="tab" data-step="3" data-intro="This is Main Navigation">
                    ...
                    Dashboard
                      ...
                      <li class="active_otp"><a href="Order.aspx"  class="order">
                    <i class="icon-cart"></i>
                   Order</a></li>
       ...
       <%--    <div class="row-fluid"> 
		  ...
		  <div class="row-fluid" id="tabs-container">
			     ...
			     <div class="sidebar_widget">
                      <div class="vertical_navigation">
                             <ul>
                            	...
                            	<li><a class="active" href="Order.aspx" title=""><i class="icon-book_alt2"> </i>All Orders</a></li>
                                <li><a href="PurchaseOrder.aspx" title=""> <i class="icon-briefcase-2"> </i>Purchase Orders</a></li>
                               
                                <li><a  href="SalesOrder.aspx" title=""><i class="icon-book_alt2"> </i>Sales Order</a></li>
                            </ul>                                              
                      </div>
			 ...
			 <div class="span9 widget_container" id="sortable">
                ...
                <div class="alert alert-info" id="seven">
                  
                    
                  <strong>Hello ! </strong><asp:Label ID="lblInvestorname" runat="server" Text="Label"></asp:Label>, <a href="http://itrade.mikasecurities.net:9215/dse/" target=_blank style=" color:#469FDB"><b> CLICK HERE TO LOGIN INTO iTRADE</b></a>
             ...
             --%>
    		   <div class="row-fluid m_b30 remove5" id="nine" data-step="5" data-intro="This Box Contains Ladger Informations">
                   <div class="span12  widget" >
                     <header class="whead w_header light"><h2><i class="icon-book-2"></i>All Orders</h2>
                        <ul class="control">
                        	<li class="dropdown">
                           ...
                           <div class="span12 padding10">
							<div class="shownpars">
								...
								<%--		<th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Date<span style="display: block;" class="sorting"></span></th>
                                        ...
                                        <%--<th>TraDate<span style="display: block;" class="sorting"></span></th>--%>
                                         <th>Transaction Date<span style="display: block;" class="sorting"></th>
                                         <th>Transaction Time</span></th>
