<%@ Page Title="" Language="C#" MasterPageFile="~/iTradex.Master" AutoEventWireup="true" CodeBehind="OrderBroker.aspx.cs" Inherits="iTradex.UI.Pages.Investor.OrderBroker" %>
			 ...
			 <div class="span3 sidebar_widget_container">
			     <div class="sidebar_widget">
                    <div class="vertical_navigation">
                        <ul>
                        <li><a class="active" href="OrderBroker.aspx" title=""><i class="icon-book_alt2"> </i>Order</a></li>
			 ...
			 <div class="span9 widget_container">
    		   ...
    		   <div class="row-fluid m_b30 remove5" id="nine" data-step="5" data-intro="This Box Contains Ladger Informations">
                   <div class="span12 widget">
                     <header class="whead w_header paste"><h2 style="color:Black;"><i class="icon-book-2"></i> List Of Orders </h2>
                        <ul class="control">
                        	<li class="dropdown">
                     ...
                     <div class="full_widget light_border collapse in" id="ledgerTable">
                       <div class="row-fluid">
                           <div class="span12 padding10">
							<div class="shownpars">
								<div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                                    ...
                                    <asp:Repeater ID="rptAllOrder" runat="server">
								...
								<thead>
                                   ...
                                   <%--<tr role="row"> <th class="balanceForward" colspan="10" style="text-align: right ;"><strong><b>Balance Forward 0.00</b></strong></th></tr>--%>
									...
									<%--	<th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Account Ref<span style="display: block;" class="sorting"></span></th>
                                        ...
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Latest EPS</th>	
                                         ...
                                         <th></th>
                                          <th class="dttableleftalign">Transaction Date<span style="display: block;" class="sorting"></th>
                                          <th class="dttableleftalign">Transaction Time</th>
                                          <th class="dttableleftalign">Account No</th>
										<th class="dttableleftalign">Instrument</span></th>
										<th class="dttableleftalign">TransactionType</th>
                                     
									    <th class="dttableleftalign">Status</th>
										<th class=" dttablerightalign">Share Quantity</th>
										<th class=" dttablerightalign">Rate</th>
                                        <th class=" dttablerightalign">Total</th>
                                 ...
                                 <ItemTemplate>
									<tr class="gradeA odd">
                                        ...
                                        <td><asp:CheckBox ID="chkAcctive"  CssClass="Checkbox" runat="server" /> </td>
										<td class="dttableleftalign">
                                        <asp:Label ID="lblTransactionDate" runat="server" Text='<%#DateTime.Parse(Eval("TransactionDate").ToString()).ToString("dd-MM-yyyy")%>'></asp:Label>
                                   </td>
                                    <td class="dttableleftalign"><%#DateTime.Parse(Eval("TransactionTime").ToString()).ToString("T")%></td>
										 <td class="dttableleftalign"><asp:Label ID="lblAccountRef" runat="server" Text='<%# Eval("InvestorACRef")%>'></asp:Label></td>
										<td class="dttableleftalign"><asp:Label ID="lblInstrument" runat="server" Text='<%# Eval("Instrument")%>'></asp:Label></td>
                                        <td class="dttableleftalign"><%# Eval("TransactionType")%></td>
									
										 <td class="dttableleftalign"><%# Eval("Status")%></td>
										 <td class="dttablerightalign"><asp:Label ID="lblShareQuantity" runat="server" Text='<%# Eval("ShareQuantity","{0:00.}")%>'></asp:Label></td>
										 <td class="dttablerightalign"><asp:Label ID="lblRate" runat="server" Text='<%# Eval("Rate", "{0:###,###,0.00}")%>'></asp:Label></td>
                        ...
                        <div id="Div1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-header">
							<button type="submit" class="close" data-dismiss="modal" aria-hidden="true">×</button>
							<h1 id="H2">Need Help ?</h1>
						</div>
						<div class="modal-body">
								<div class="bb-custom-wrapper">
									...
									<nav>
										<a id="A1" href="#">Previous</a>
										<a id="A2" href="#">Next</a>
										<a id="A3" href="#" title="Go to last item">Last page</a>
									</nav>
								</div>								
						</div>
                   ...
                   <%--<asp:Button ID="btnAdd"  runat="server" class="btn appBtn btn-primary fwBtn2"  data-toggle="modal" data-target="#myModal2" Text="Add" OnClick="btnAdd_Click"/>--%>
                            <button id="btnAccept" runat=server  onserverclick="btnAccept_Click" class="btn appBtn btn-primary btnForm btnBrokerFundwithdraw BrokerOrderButton "><i class="icon-checkmark"></i> Accept</button>
                            <button id="btnReject" runat=server  onserverclick="btnReject_Click" class="btn appBtn btn-danger btnForm btnBrokerFundwithdraw BrokerOrderButton"><i class="icon-cancel-2"></i> Reject</button>
                          <%--  <button id="Button1" onserverclick="btnPrint_Click" runat="server" class="btn appBtn btn-primary fwBtn2 btnBrokerFundWithdrawPrint"><i class=" icon-file-pdf"></i> Print</button>--%>
                            <%--<input type="button" class="btn appBtn  fwBtn2" value="Print" id="btnPrint" onClick="window.print()" />--%>
                             <button id="Button1" onserverclick="btnPrint_Click" runat="server" class="btn appBtn btn-primary btnBrokerFundwithdraw BrokerOrderButton ">
